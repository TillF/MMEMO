...
#nohup R --vanilla -f calibrate_main_dds.R --slave > console_output.txt &
    ...
    log_gw_delay_f=c(log10(1e-3),log10(100)),
    log_soildepth_f=c(log10(0.1),log10(10)),
    log_kf_bedrock_f=c(log10(1e-5),log(1e2)),
    riverdepth_f=c(1e-1,15),
    log_kf_scale_f=c(log10(1e-2),log10(2500)),         #5 
    log_ksat_factor=c(log10(1e-2),log10(30)),
